...
c <- c(1,2,3,4)
g <- read.graph("test0426/5-1.graphml", "graphml")
V(g)$color <- 1
...
graph <- read.graph("test0427/9.graphml", "graphml")
# graph <- read.graph("test0426/5-1.graphml", "graphml")
...
plot(graph, layout = layout_as_bipartite, vertex.size = 40, vertex.label.cex = 1, vertex.label = V(graph)$name, vertex.color = 'orange')
